...
<html>
    ...
    <body>
        <form action="visBoenheter" method="post" enctype="multipart/form-data">
            ...
            <p><input type="text" name="Bestilling-kategori" value="" placeholder="Kategori:" id="input-bestilling" required > </input> </p>
            <p><button  id="button" type="submit" name="Submit"   class="btn " data-loading-text="<span>Vis boenheter</span>">Søk</a></button>
                </div>
